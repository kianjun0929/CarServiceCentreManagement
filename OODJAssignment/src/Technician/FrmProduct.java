...
public class FrmProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel5);
        jPanel5.setBounds(0, 210, 250, 50);
        ...
        jLabel12.setBounds(70, 270, 130, 30);

        jLabel13.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Manage Appointment");
        ...
        jLabel13.setBounds(60, 320, 150, 30);
        ...
        jLabel15.setBounds(70, 370, 120, 30);
        ...
        jPanel2.add(btnAdd);
        btnAdd.setBounds(630, 280, 120, 50);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product ID", "Category Name", "Product Name", "Product Description", "Date Added", "Price", "Quantity", "Status"
            }
        ));
        ...
        jScrollPane1.setBounds(30, 400, 720, 330);
        ...
        jPanel2.add(btnEdit);
        btnEdit.setBounds(30, 280, 120, 50);
        ...
        txtSearch.setBounds(30, 330, 720, 60);
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        ProductDetails.add(regDate);
        ProductDetails.add(price);
        ProductDetails.add(quantity);
        ProductDetails.add(Status);
        Product product = new Product(ProductDetails);
        
//        Product product = new Product(ProductID, CategoryName, ProductName, ProductDescription, regDate, price, quantity, Status);
        Validation check = new Validation();

        try {
            if(check.isDouble(price) && check.isInt(quantity)) {
                if(!ProductID.isEmpty() && !CategoryName.isEmpty() && !ProductName.isEmpty() && !ProductDescription.isEmpty() ) {
                    if(check.checkProductName(ProductName)) {
                        product.Add();
                        //addProduct.AddProduct(ProductID, CategoryName, ProductName, ProductDescription, price, quantity, Status);
                        JOptionPane.showMessageDialog(rootPane, "The product is added.", "Product Added", JOptionPane.INFORMATION_MESSAGE);
                        this.dispose();
                        new FrmProduct().setVisible(true);
                    } else {
                        JOptionPane.showMessageDialog(rootPane, "The product has already existed in the system.", "Duplication of product name", JOptionPane.WARNING_MESSAGE);
                    }
                } else {
                    JOptionPane.showMessageDialog(rootPane, "Please make sure that you have entered all the text fields.");
                }
            } else {
                JOptionPane.showMessageDialog(rootPane, "Please make sure that you have entered correct value for Price and Quantity");
            }
    ...
    void Display() {
        DataAccess da = new DataAccess();
        ArrayList<String> data = null ;
        jTable1.setModel(new DefaultTableModel(null, new String[]{"Product ID", "Category Name", "Product Name", "Product Description", "Date Added", "Price", "Quantity", "Status"}));
        da.setFileName("Product.txt");
        int row = 0;
        data = da.readAll();
        for (int i = 0; i < data.size(); i++) {//row
    ...
    public void selectrow() {
        try {
            ...
            String ProductID = model.getValueAt(num, 0).toString();
            String CategoryName = model.getValueAt(num, 1).toString();
            String ProductName = model.getValueAt(num, 2).toString();
            String ProductDescription = model.getValueAt(num, 3).toString();
            String DateAdded = model.getValueAt(num, 4).toString();
            String Price = model.getValueAt(num, 5).toString();
            String Quantity = model.getValueAt(num, 6).toString();
